...
if selected =="Healthy Back Tips":
    ...
    with col1:
        st.write('')
    with col2:
        st.image("https://southfloridabackspineandscoliosis.com/wp-content/uploads/2020/05/tips-for-healthy-spine-Hepler-436x1024.png")
    with col3:
        st.write('')
    col1,col2,col3=st.columns(3)
    with col1:
         st.write('')
    with col2:
         st.image("https://www.tekpartners.com/wp-content/uploads/2020/04/Good-Posture.png")
    with col3:
         st.write('')
